...
<body>
    ...
    ?>
    <form action="MoreInfoLotes.php" method="GET">
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <?php foreach ($resultado as $lotes) { ?>
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Sale badge-->
                                <!-- <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div> -->
                                <!-- Product Id -->
                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($lotes['idLotes']); ?>">
                                <!-- Product image-->
                                <?php
                                echo '<img  height="170" src="data:image/jpeg;base64,' . base64_encode($lotes['imagen']) . '"/>';
                                ?>
                                <!-- Product details-->
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <h5 class="fw-bolder"><?php echo $lotes['ubicacion'] ?></h5>
                                        <!-- Product reviews-->
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <button type="submit" name="idLotes" class="btn btn-outline-dark mt-auto" value="<?php echo htmlspecialchars($lotes['idLotes']); ?>">Mas informacion</button>
                                    </div>
                                </div>
                            </div>
                        </div>
